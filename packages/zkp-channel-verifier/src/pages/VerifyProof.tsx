...
import { CheckCircle2, Info, FileText, ArrowLeft, Check, X } from "lucide-react";
      ...
      <div className="min-h-screen pb-20" style={{ padding: "32px" }}>
        <div className="max-w-7xl w-full mx-auto">
          ...
          <div className="bg-gradient-to-b from-[#1a2347] to-[#0a1930] border border-[#4fc3f7] shadow-lg shadow-[#4fc3f7]/20" style={{ padding: "32px", marginBottom: "48px" }}>
            ...
            <div>
              <h2 className="text-lg font-bold text-white">Verification Overview</h2>
              <p className="text-sm text-gray-400">Current verification status and statistics</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2" style={{ gap: "32px" }}>
            <div className="bg-gradient-to-b from-[#1a2347] to-[#0a1930] border border-[#4fc3f7]/30 hover:border-[#4fc3f7] transition-all hover:shadow-lg hover:shadow-[#4fc3f7]/20" style={{ padding: "20px" }}>
              ...
              <div className="text-3xl font-bold text-white">
                {verificationResult === "success" ? "Verified" : verificationResult === "failure" ? "Failed" : "Pending"}
              </div>
            </div>
            ...
            <div className="bg-gradient-to-b from-[#1a2347] to-[#0a1930] border border-[#4fc3f7]/30 hover:border-[#4fc3f7] transition-all hover:shadow-lg hover:shadow-[#4fc3f7]/20" style={{ padding: "20px" }}>
              ...
              <div className="text-3xl font-bold text-white">{uploadedFile ? 1 : 0}</div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-b from-[#1a2347] to-[#0a1930] border border-[#4fc3f7] shadow-lg shadow-[#4fc3f7]/20" style={{ padding: "32px", marginBottom: "48px" }}>
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Upload and verify your proof files</p>
            </div>
          </div>
          ...
          >
            ...
            <span className="font-semibold">Upload Proof & State ZIP File</span>
          </button>
            ...
            <div className="p-4 bg-[#0a1930]/50 border border-[#4fc3f7]/30">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-gray-400 text-xs font-mono truncate">{uploadedFile.path}</p>
                </div>
              </div>
            </div>
          )}
          ...
          >
            <div className="flex items-center" style={{ gap: "12px" }}>
              <div className={`p-2 rounded ${!uploadedFile || isVerifying ? "bg-gray-700" : "bg-green-500"}`}>
                <Check className="w-5 h-5 text-white" />
              </div>
              <div className="text-left">
                <p className="font-semibold">{isVerifying ? "Verifying Proof..." : "Verify Proof"}</p>
                <p className="text-xs text-gray-400">Run verification on uploaded files</p>
              </div>
            </div>
          ...
          {verificationResult && verificationResult !== "pending" && (
            <div className={`bg-gradient-to-b from-[#1a2347] to-[#0a1930] border-2 ${
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            <li className="flex items-start gap-2">
              ...
              <span>Upload a ZIP file containing your proof and EVM state files</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#4fc3f7] mt-1">•</span>
              <span>Click "Verify Proof" to start the verification process</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#4fc3f7] mt-1">•</span>
